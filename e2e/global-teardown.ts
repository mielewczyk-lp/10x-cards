...
async function globalTeardown() {
  ...
  console.log(`Deleting flashcards for user: ${e2eUserId}`);
  ...
  try {
    ...
    console.log('Successfully authenticated as E2E user');
    ...
    if (countError) {
      ...
      console.log(`Found ${existingFlashcards?.length ?? 0} flashcards to delete`);
    }
